{if count($boxNs->$box_id->list)}
                    <div class="box{if 1 == $boxNs->$box_id->format} slider loading{if 1 == $boxNs->$box_id->automove} slider_automove{/if}{/if}" id="box_specialoffer">
                        <div class="boxhead">
                        ...
                        <div class="innerbox">
                            ...
                            <div data-product-id="{$special_product->product->product_id}" data-category="{$special_product->defaultCategory->translation->name|escape}" {if $special_product->product->producer_id}data-producer="{$special_product->producer->manufacturer->name|escape}"{/if} class="product center row{if $special_product->readVisibilityConfigListItemGrayFlag()} product_inactive{/if}">
                                <a href="{route function='product' key=$special_product->getIdentifier() productName=$special_product->translation->name productId=$special_product->getIdentifier()
                                    ...
                                    <span class="boximgsize row lazy-load">
                                        <img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" data-src="{imageUrl type='productGfx' width=$skin_settings->img->medium height=$skin_settings->img->medium image=$special_product->getPromotingGfxName() overlay=1}" alt="{$special_product->translation->name|escape}">

                                        <noscript>
                                            <img src="{imageUrl type='productGfx' width=$skin_settings->img->medium height=$skin_settings->img->medium image=$special_product->getPromotingGfxName() overlay=1}" alt="{$special_product->translation->name|escape}">
                                        </noscript>
                                    </span>
                                            ...
                                            {if $special_product->specialOffer}
                                                ...
                                                {if $isRegularPriceVisible}
                                                    <p class="price__regular">
                                                        ...
                                                        <del class="price__inactive">{currency value=$special_product->defaultStock->getPrice()}</del>
                                                    </p>
                                                {/if}
                                                ...
                                                {if $showLowestPriceHistory && $isLowestPriceVisible}
                                                    <div class="f-row clear price__omnibus">
                                                        ...
                                                        <strong class="price__inactive">
                                                            {currency value=$special_product->stock->getHistoricalLowestPrice()}
                                                        </strong>
                                                    </div>
                                                {/if}
                                                ...
                                                {if $special_product->currency and $currency->getIdentifier() != $special_product->currency->getIdentifier()}
                                                    <p class="product__currency price__currency">
                                                        {translate key="Price"} ({$special_product->currency->currency->name|escape}):
                                                        <em class="default-currency">{currency id=$special_product->product->currency_id rate=1 value=$special_product->defaultStock->getCurrencySpecialOfferPrice()}</em>
                                                    </p>
                                                {/if}
                                            {else}
                                                <p>
                                                ...
                                                {if $special_product->currency and $currency->getIdentifier() != $special_product->currency->getIdentifier()}
                                                    <p class="product__currency price__currency">
                                                        {translate key="Price"} ({$special_product->currency->currency->name|escape}):
                                                        <em class="default-currency">{currency id=$special_product->product->currency_id rate=1 value=$special_product->defaultStock->getCurrencyPrice()}</em>
                                                    </p>
                                                {/if}
                                            {/if}
                                        {/if}
                                        ...
                                        {if $price_mode != '3'}
                                            ...
                                            {if $special_product->specialOffer}
                                                ...
                                                {if $isRegularPriceVisible}
                                                    <p class="price__regular">
                                                        {translate key="Regular price"}:
                                                        <del class="price__inactive">{currency value=$special_product->defaultStock->getPrice(true)}</del>
                                                    </p>
                                                {/if}
                                                ...
                                                {if $showLowestPriceHistory && $isLowestPriceVisible}
                                                    <div class="f-row clear price__omnibus">
                                                        {translate key='Lowest price'}:
                                                        <strong class="price__inactive">
                                                            {currency value=$special_product->stock->getHistoricalLowestPrice(true)}
                                                        </strong>
                                                    </div>
                                                {/if}
                                                ...
                                                {if $special_product->currency and $currency->getIdentifier() != $special_product->currency->getIdentifier()}
                                                    <p class="product__currency price__currency">
                                                        {translate key="Price"} ({$special_product->currency->currency->name|escape}):
                                                        <em class="default-currency">{currency id=$special_product->product->currency_id rate=1 value=$special_product->defaultStock->getCurrencySpecialOfferPrice(true)}</em>
                                                    </p>
                                                {/if}
                                            {else}
                                                <p>
                                                ...
                                                {if $special_product->currency and $currency->getIdentifier() != $special_product->currency->getIdentifier()}
                                                    <p class="product__currency price__currency">
                                                        {translate key="Price"} ({$special_product->currency->currency->name|escape}):
                                                        <em class="default-currency">{currency id=$special_product->product->currency_id rate=1 value=$special_product->defaultStock->getCurrencyPrice(true)}</em>
                                                    </p>
                                                {/if}
                                            {/if}
                                            {if $price_mode != '2'}
