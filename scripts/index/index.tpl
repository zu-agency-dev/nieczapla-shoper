                  ...
                  {if 1 == $skin_settings->productlist->allowviewchange}
                    <ul class="prodview inline text-right">
                      <li class="photo{if 'phot' == $view} selected{/if}">
                        <a class="fa fa-th"
                          href="{route function='indexpage' key=0 page=1 sort=1 view='phot'}{if $google}?{$google|escape}{/if}"
                          title="{translate key='Picture view'}"></a>
                      </li>
                      <li class="full{if 'full' == $view} selected{/if}">
                        <a class="fa fa-th-list"
                          href="{route function='indexpage' key=0 page=1 sort=1 view='full'}{if $google}?{$google|escape}{/if}"
                          title="{translate key='Full view'}"></a>
                      </li>
                    </ul>
                  {/if}
                </div>
