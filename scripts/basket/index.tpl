...
{include file='body_head.tpl'}
                                        ...
                                        <tbody>
                                            {foreach from=$user->basket item=basket_product}
                                                {if !$basket_product->isChild()}
                                                    <tr data-id="{$basket_product->getIdentifier()}" data-product-id="{$basket_product->product->product->product_id}" data-category="{$basket_product->product->defaultCategory->translation->name|escape}" {if $basket_product->product->product->producer_id}data-producer="{$basket_product->product->producer->manufacturer->name|escape}"{/if}>
                                                        <td class="img large">
                                                        ...
                                                        <td class="name">
                                                            {if !$basket_product->isChild()}
                                                                ...
                                                                <span class="variant break_word">{$basket_product->getName()|escape}</span>
                                                            {/if}
                                                                    ...
                                                                    <div class="bundle-products">
                                                                        {foreach from=$basket_product->getChildren() item=bundle}
                                                                            <p>
                                                                                ...
                                                                                <span class="variant break_word">{$bundle->getName()|escape}</span>
                                                                            </p>
                                                                        {/foreach}
                                                                    </div>
                                                                {/if}
                                                        ...
                                                        <td class="rwd-hide-small price">
                                                            {if $basket_product->isLoyaltyExchanged()}
                                                                <span class="color_dim line-through">{currency value=$basket_product->getPrice(false, true)}</span>
                                                            {else}
                                                                {currency value=$basket_product->getPrice()}
                                                            {/if}
                                                            
                                                            {if $basket_product->isLoyaltyExchanged()}
                                                                <br>{$basket_product->getLoyaltyPoints()} {translate key="pts"}

                                                                {if $basket_product->getPrice() != 0}
                                                                    + {currency value=$basket_product->getPrice()}
                                                                {/if}
                                                            {/if}
                                                        </td>
                                                        ...
                                                        <td class="sum">
                                                            {if $basket_product->isLoyaltyExchanged()}
                                                                <em class="color_dim line-through">{currency value=$basket_product->getPriceForAll(false, true)}</em>
                                                            {else}
                                                                <em class="color">{currency value=$basket_product->getPriceForAll()}</em>
                                                            {/if}
                                                            
                                                            {if $basket_product->isLoyaltyExchanged()}
                                                                <br><em class="color">{$basket_product->getLoyaltyPointsForAll()} {translate key="pts"}</em>
                                                                {if $basket_product->getPriceForAll() != 0}
                                                                    + {currency value=$basket_product->getPriceForAll()}
                                                                {/if}
                                                            {/if}
                                                        </td>
    ...
    <script type="text/javascript">
        try {literal}{{/literal} 
            ...
            Shop.values.ShippingHidden = {$shipping_extra_step}; 
            Shop.values.deliveryTimes = {$basketProductDeliveryTimeNames};
