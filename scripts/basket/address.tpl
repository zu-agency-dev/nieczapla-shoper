...
{include file='body_head_checkout.tpl'}
                                    ...
                                    <div class="innerbox">
                                                                ...
                                                                {foreach from=$table1 item=tr}
                                                                    <tr class="{$tr.name|escape} {if $tr.name == 'phone'}js__phone-table-row{/if}">
                                                                            ...
                                                                            {if $tr.name == 'phone'}
                                                                                <div 
                                                                                    ...
                                                                                    data-inpost-shipping="{$isSelectedInpostShipping}">
                                                                                        <select 
                                                                                            name="phone_country" 
                                                                                            class="select__phone js__phone-country-select"
                                                                                            autocomplete="chrome-off">
                                                                                                <option 
                                                                                                    ...
                                                                                                    {if $phone_country == constant('Form_Shop_Address::PHONE_TYPE_POLAND')} 
                                                                                                        selected="selected"
                                                                                                    {/if}
                                                                                                    data-background-source="/libraries/flags/pl_PL.png"
                                                                        ...
                                                                        <td class="input">
                                                                            ...
                                                                            {else}
                                                                                <div class="shaded_inputwrap{if $tr.error} error{/if} {if $tr.name == 'phone'} js__input-container{/if}" >
                                                                                    <input 
                                                                                        type="{$tr.type|escape}" 
                                                                                        name="{$tr.name|escape}" 
                                                                                        value="{$tr.value|escape}" 
                                                                                        id="input_{$tr.name|escape}"
                                                                                        {if $tr.readonly == true} readonly{/if}
                                                                                        {if $tr.name == 'phone'}
                                                                                            data-input-mask-instance="false"
                                                                                        {/if}>
                                                                                </div>
                                                                            {/if}
                                                                        </td>
                                                                ...
                                                                {foreach from=$table3 item=tr}
                                                                    <tr class="different {$tr.name|escape} {if $tr.name == 'phone2'}js__phone-table-row{/if}">
                                                                        ...
                                                                        <td class="input">
                                                                            ...
                                                                            {else}
                                                                                <div class="shaded_inputwrap{if $tr.error} error{/if} {if $tr.name == 'phone2'} js__input-container{/if}" >
                                                                                    <input 
                                                                                        {if $tr.name == 'zip2'}
                                                                                            data-mask="__-___" 
                                                                                            data-pattern="{literal}^(\d{2})(-)(\d{3})${/literal}" 
                                                                                            data-valid-pattern="00-000"
                                                                                        {/if}
                                                                                        {if $tr.name == 'phone2'}
                                                                                            data-input-mask-instance="false"
                                                                                        {/if}
                                        ...
                                        <div class="bottombuttons">
                                            ...
                                            <button 
                                                ...
                                                name="button1" 
                                                value="button1" 
                                                class="btn back js__no-validate">
                                                    <img src="{baseDir}/libraries/images/1px.gif" alt="" class="px1" >
    ...
    <script type="text/javascript">
        try {literal}{{/literal} 
            ...
            {feature name="vat_eu"}{if $isEnabledVatEU}Shop.values.countryCode={$shopCountry}; Shop.values.euCountries = [{foreach from=$countriesVatEU item=country}{$country},{/foreach}];{/if}{/feature} 
