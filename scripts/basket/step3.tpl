                        ...
                        <div class="innerbox">
                                    ...
                                    {foreach from=$user->basket item=basket_product}
                                        {if !$basket_product->isChild()}
                                            <tr data-product-id="{$basket_product->product->product->product_id}" data-category="{$basket_product->product->defaultCategory->translation->name|escape}" {if $basket_product->product->product->producer_id}data-producer="{$basket_product->product->producer->manufacturer->name|escape}"{/if}>
                                                ...
                                                {if $showDelivery}
                                                    {assign var=productDeliveryName value=$basketProductDeliveryNames[$id]}
                                                    <td class="time rwd-hide-medium rwd-hide-small">{$productDeliveryName|escape}</td>
                                                {/if}
                                                <td class="quantity">
                                            ...
                                            {if $deliveryName}
                                                <li class="date">
                                                    <span>
                                                        ...
                                                        <strong class="date">{$deliveryName|escape}</strong>
                                                    </span>
                                                </li>
                                            {/if}
                                ...
                                <div class="taxes">
                                    ...
                                    {if $isLocalizedTaxDetected && !$additional_tax_info}
                                        ...
                                        <span class="cost">{currency value=$sum_net_curr rate=1}</span><br>
                                        ...
                                        <span class="cost">{currency value=$tax_sum_curr rate=1}</span><br>
                                    {/if}
                                </div>
                                ...
                                <p class="sum">
                                    ...
                                    <span class="sum">{currency value=$sum_curr rate=1}</span>
                                </p>
