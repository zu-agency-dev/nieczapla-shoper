...
{include file='body_head.tpl'}
    <div class="js__code-verification-service main row rodo" data-service="rodo">
                ...
                <div class="rodo__container center-row s-grid-6">
                    <div class="box">
                        <form action="" method="post">
                            <fieldset>
                                <div class="boxhead">
                                    <h3><img src="{baseDir}/libraries/images/1px.gif" alt="" class="px1">{translate key="Enter a verification code that we have sent to your email"}</h3>
                                </div>
                                <div class="f-row">
                                ...
                                <div class="f-row">
                                    ...
                                    {/capture}
                                    <p>{translate key="Did not receive an email? %sGet a new access code%s" p1="<a data-customer-email='$marked_email' data-action='$route' verification-get-new-code>" p2="</a>"}</p>
                                </div>
                                <div class="f-row">
                                ...
                                <div class="bottombuttons f-row">
                                    <div class="center-row f-grid-6">
                                        <button verification-submit-action type="submit" name="download" value="download" class="btn btn-red">
                                            <img src="{baseDir}/libraries/images/1px.gif" alt="{translate key='Done'}" class="px1">
                                            <span>{translate key='Download your archive'}
                                                (<span class="js__convert-size-pretty">{$archive_size|escape}</span>)
											</span>
                                        </button>
