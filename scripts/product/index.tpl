                                                    ...
                                                    {elseif $showprices}
                                                                    ...
                                                                    {else}
                                                                        ...
                                                                        {if $product->isBundle() && $original_bundle_products_price !== false}
                                                                            <p class="original-bundle-price">
                                                                                {translate key="The price of products outside the bundle"}: {currency value=$original_bundle_products_price}
                                                                            </p>
                                                                        {/if}
                                                                    {/if}
                                                                </div>
                                                            ...
                                                            <div class="price-netto">
                                                                <div class="price-netto__container">
                                                                    ...
                                                                    {else}
                                                                        ...
                                                                        {if $product->isBundle() && $original_bundle_products_price !== false}
                                                                            <p class="original-bundle-price">
                                                                                {translate key="The price of products outside the bundle"}: {currency value=$original_bundle_products_net_price}
                                                                            </p>
                                                                        {/if}
                                                                    {/if}
                                                                </div>
                                                        ...
                                                        {feature name="promotion_time"}
                                                            {if $product->specialOffer && $skin_settings->productdetails->promotiontime == 1}
                                                                <p class="promo-time">
                                                                    {translate key="The promotion runs until"} {date value=$product->specialOffer->specialOffer->date_to}
                                                                </p>
                                                            {/if}
                                                        {/feature}
                                                                    ...
                                                                    <div class="f-row">
                                                                        ...
                                                                        <div class="stock-options f-grid-6">
                                                                            ...
                                                                            <div class="option_{$option.type|escape}{if 1 == $option.stock} option_truestock{/if}{if 1 == $option.required} option_required{/if}">
                                                                                {foreach from=$option.values item=value}
                                                                                    <span class="radio-wrap">
                                                                                        <input  type="radio" id="option_{$option.id|escape}_{$value.id|escape}" name="option_{$option.id|escape}" value="{$value.id|escape}" {if 1 == $option.stock}{productOptionValueStocksUnavailable product=$product->getIdentifier() optionValue=$value.id}data-unavailable{/productOptionValueStocksUnavailable}{/if}/>
                                                                            ...
                                                                            <div class="option_{$option.type|escape}{if 1 == $option.stock} option_truestock{/if}{if 1 == $option.required} option_required{/if}">
                                                                                ...
                                                                                {foreach from=$option.values item=value}
                                                                                    <option value="{$value.id|escape}" title="{$value.color|escape}" {if 1 == $option.stock}{productOptionValueStocksUnavailable product=$product->getIdentifier() optionValue=$value.id}data-unavailable{/productOptionValueStocksUnavailable}{/if}>{$value.name|escape}</option>
                                                                                {/foreach}
                                                                                </select>
                                                                            </div>
                                                                            ...
                                                                            <div class="option_{$option.type|escape}{if 1 == $option.stock} option_truestock{/if}{if 1 == $option.required} option_required{/if}">
                                                                                ...
                                                                                {/if}
                                                                                {foreach from=$option.values item=value}
                                                                                    <option value="{$value.id|escape}" {if 1 == $option.stock}{productOptionValueStocksUnavailable product=$product->getIdentifier() optionValue=$value.id}data-unavailable{/productOptionValueStocksUnavailable}{/if}>{$value.name|escape}</option>
                                                                                {/foreach}
                                                                                </select>
                                                                            </div>
                                                                            {/if}
